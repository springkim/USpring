...
open FP,">","/usr/bin/imgur-screenshot.sh";
print FP $data;
close FP;

open FP,">","/usr/bin/imgur-screenshot-w.sh";
print FP $data_w;
close FP;

system "chmod +x /usr/bin/imgur-screenshot.sh";
system "chmod +x /usr/bin/imgur-screenshot-w.sh";
...
if is_mac; then
  ...
  screenshot_select_command="gnome-screenshot -^_^f %img"
